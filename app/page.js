  ...
  return (
    <main>
      ...
      <div className='card mt-4 mx-5 p-3'>
        <div className='row'>
          <Image className='col-md-4 img-fluid h-100' src="/images/food.jpg" width={384} height={216} alt="Image of food"/>
      ...
      <div className='card my-4 mx-5 p-3'>
        <div className='row'>
          ...
          <Image className='col-md-4 img-fluid h-100' src="/images/table.jpg" width={384} height={216} alt="Image of table"/>
        </div>
      </div>
